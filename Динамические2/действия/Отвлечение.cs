...
namespace Динамические.действия
{
    ...
    public class СвойствоПодписки
    {
        ...
        public List<List<РАМОбъект>> АдресаПодписчиковНаСобытие;
        public Dictionary<СтрокаЮникода, List<Action<object>>> СписокРеакцийНаСобытие;

        public void ДобавитьАдресКСобытию(РАМОбъект адрес, string ИмяСобытия)
        {
