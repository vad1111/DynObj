...
{
    public class ОпределениеКласса : РАМОбъект // например имена полей это может быть список внутренних переменных для Действий 
    {
    ...
    public class ЭкземплярКласса: РАМОбъект // 
    {
        public ОпределениеКласса Класс;
        public List<РАМОбъект> СписокЗначений;
    ...
    public class СоздатьЭкземплярКласса : План // это new ТИп()
    {
        ...
        public override object Выполнить(План вызывающееДействие)
        {
            ...
            var экземпляр = new ЭкземплярКласса
            {
                ...
                СписокЗначений = new List<РАМОбъект>
                {
    ...
    public class ПрисвоитьЗначениеПолю : План
    {
        ...
        public override object Выполнить(План вызывающееДействие)
        {
            ...
            экземпляр.СписокЗначений[номерПоля] = (РАМОбъект) ПрисваиваемоеЗначение; return "готово";
        }
    }
