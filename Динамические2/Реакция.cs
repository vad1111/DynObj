...
namespace Динамические
{
    ...
    {
        private РАМОбъект Обстоятельства; //Список произошедших событий 
    ...
    public class Накопитель : Активность // Накопитель Событий, если надо определить одновременное появление событий (расширенное логическое И)(узел шаблона 
    {
        ...
        public override void ПолучиСообщение(Связь связь, РАМОбъект сообщение) // это сообщение посылает либо активность представляющая ее части, либо пустой такт 
        {
