...
namespace Динамические.активности
{
    ...
    // это разновидность активности, со временными связями
    public class РегистраторАдресов: РАМОбъект
    {
        public class Клиент
        {
            public РАМОбъект АдресВКуче;
            public LinkedList<РАМОбъект> СписокАдресовВКуче;
            public Guid Пароль;
            public Клиент(РАМОбъект п, Guid пар)
            {
                АдресВКуче = п;
                Пароль = пар;
            }
        ...
        public bool Зарегистрируй(int адрес, РАМОбъект адресВКуче, Guid пароль) 
        {
        ...
        public  АдресУРегистратора ЗарегистрируйНаСвободныйАдрес(РАМОбъект адресВкуче, Guid пароль)
        {
        ...
        public РАМОбъект ДайАдресВкуче(int адрес)
        {
