...
namespace Динамические
{
    public class Канал: РАМОбъект
    {
        ...
        public Action<РАМОбъект> Получи;
        public Func<РАМОбъект> ДайВходящее;
        // это только от связи
        public Action<РАМОбъект> ПередайИсходящееСообщение;
      
        public virtual РАМОбъект ДайВходящееСообщение()
        {
            return null;
        }
    }
