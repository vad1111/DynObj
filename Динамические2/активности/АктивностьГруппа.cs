...
namespace Динамические.активности
{
    class АктивностьГруппа: Активность
    {
        ...
        РАМОбъект ДайАдресНовойСвязиАктивности(ЦелоеЧисло номер)
        {
        ...
        РАМОбъект ДайЭлемент(ЦелоеЧисло номер)
        {
    ...
    public class АктивностьЗначение : Активность
    {
        ...
        public РАМОбъект Значение = Пустота.Статик;
        РАМОбъект ДайЗначение()
        {
            return Значение;
        }

        РАМОбъект НаЗначение(РАМОбъект объект)
        {
            Значение = объект;
