...
namespace Динамические
{
    ...
    public class АдресВАктивности : Адрес
    {
        ...
        {
            if (АдресАктивностиВКуче == null) АдресАктивностиВКуче = (Активность) АдресРОдительскойАктивности.АдресВКуче();
    ...
    public class Активность : ПримитивИлиАдрес
    {
        public Строка Имя;
        ...
        private ПримитивИлиАдрес ТекущееСостояние;
        ...
        public virtual void ПолучиСообщение(Связь связь, ПримитивИлиАдрес сообщение) // получи, возьми это команда снаружи
        ...
        internal virtual void ОтослатьСообщениеВсемИсходящим(object сообщение)  //это внутрення реакция   внутреннее команда отдай  реакция на сообщения
        {
            ...
            {
               ((Связь) получатель).ПередайСообщение((ПримитивИлиАдрес) сообщение);
            }
