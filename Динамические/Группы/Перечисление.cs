...
namespace Динамические.Группы
{
    ...
    public class ЭлементПеречисления
    {
        ...
        public Строка Описание => Группа.ДайОписание(this);// для флагов это будет список Строк
    ...
    public class ГруппаПеречисления
    {
        ...
        public List<Строка> СписокОписанийЭлементов;
        ...
        internal Строка ДайОписание(ЭлементПеречисления элементПеречисления)
        {
    ...
    public class ГруппаФлагов
    {
        ...
        public ЭлементПеречисления ДайЭлементПоСпискуОписаний(Строка[] описания)
        {
            var элемент = new ЭлементПеречисления { флаги = new byte[СписокОписанийЭлементов.Count] };
